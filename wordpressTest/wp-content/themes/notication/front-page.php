						...
						<div class="p-top-information__inner l-section__inner">
							<div class="p-top-information__title">
								...
								if ($categories) {
									...
									?>
									<div class="p-top-information__title__button__link">
										<a href="<?php echo esc_url($first_category_link); ?>" class="p-top-information__title__button__link">一覧へ<span class="myfont myfont-circle_arrow"></span></a>
									</div>
								<?php } ?>
							</div>
								...
								<ul class="p-top-information__detail__list">
									...
									while ($posts->have_posts()) :
										...
										<li class="p-top-information__detail__list__item">
											<a href="<?php echo esc_url(get_permalink()); ?>" class="p-top-information__detail__list__item__wrap">
												<time class="p-top-information__detail__list__item__time"><?php echo esc_html(get_the_date('Y.m.d')); ?></time>
												<h3 class="p-top-information__detail__list__item__title"><?php echo esc_html(get_the_title()); ?></h3>
											</a>
										</li>
									<?php endwhile; ?>
								</ul>
					...
					<section class="p-top-recruit">
						<div class="p-top-recruit__inner">
							...
							<div class="p-top-recruit__button">
								<div class="c-button">
									<a href="https://c.nishinippon.co.jp/recruit/" target="_blank" class="c-button__link">
										<span>採用サイトはこちら</span>
										<span class="myfont myfont-barred_arrow"></span>
									</a>
								</div>
