  ...
  <div class="wrap clearfix">
    ...
    <ul class="tbanner is-pc">
      ...
      <li><a href="<?php echo home_url(); ?>/time"><img src="<?php bloginfo('template_directory'); ?>/assets/img/top/tbanner04.png" alt="営業時間のご案内"></a></li>
			<li><a href="https://www.instagram.com/create_munakata/?hl=ja" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/assets/img/top/tbanner07.png"></a></li>
      <li><a href="<?php echo home_url(); ?>/open"><img src="<?php bloginfo('template_directory'); ?>/assets/img/top/tbanner08.png" alt="テナント募集"></a></li>
    </ul>
  </div>
</section>
<section class="is-sp">
