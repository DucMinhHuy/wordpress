...
<head>
	...
	<title>お問い合わせ｜CPCエナジー株式会社</title>
		...
		<div class="l-contents-detail">
			<main class="l-main l-form">
				...
				<section class="l-hero">
					<figure class="p-hero_title_eng"><img src="/assets/img/contact_hero_title.svg" alt=""></figure>
					<p class="p-hero_title_jap">お問い合わせ</p>
				</section>

				<section class="l-form_finish c-inner">
				<h2 class="p-thanks_h2">お問い合わせいただきありがとうございました。<br class="sp_display">お問い合わせを受け付けました。</h2>
				<a href="/_index.php"><button class="c-standerd_button_format">トップページ</button></a>
				</section>
				...
				<section class="l-breadcrumb c-inner">
                    <ul class="l-breadcrumb-list">
                        ...
                        <li class="l-breadcrumb-list__item"><span class="l-breadcrumb-list__text">お問い合わせ</span></li>
                    </ul>
                </section>
